...
import {Button, Container, Title, Form, Input, Label, Select} from '@/styles/basic';
...
const CreateCompanyPage: React.FC = () => {
    ...
    const blockedValues = ["id", "user_id", "created_at", "updated_at", "updated_by", "created_by"];
    ...
    if (profileError) {
        ...
        console.log('Company created and user linked:', companyData);
                ...
                return (
                    <div key={key}>
                        ...
                        {typeof value === 'string' && key === 'name' ? (
                            <Input type="text" id={key} name={key} value={value} onChange={handleChange} required />
                            ...
                            <Input type="number" id={key} name={key} value={value} onChange={handleChange} />
                        ) : (
